<template>
	<view class="diy_details diy_div_barter">
		<view v-if="Object.keys(obj).length!==0" class="warp">
			<view class="container">
				<view class="row">
					...
					<view v-if="$check_field('get','required_barter')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>所需易物:</span>
						</view>
							<view class="diy_field diy_text">
					...
					<view v-if="$check_field('get','item_introduction')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>物品介绍:</span>
						</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/barter/get_obj", {
					barter_id:this.query.barter_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["barter_id"] !==0) {
