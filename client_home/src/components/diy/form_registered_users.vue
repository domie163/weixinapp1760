<template>
	<div>
			<view v-if="$check_register_field('add','user_name','/registered_users/view')" class="col-12 col-md-6">
			<view class="diy_title">
				...
				<view v-if="$check_register_field('add','user_gender','/registered_users/view')" class="col-12 col-md-6">
			<view class="diy_title">
				<text>
					用户性别:
				</text>
			...
			<view class="diy_field diy_down">
				...
				<view v-if="$check_register_field('add','user_identity','/registered_users/view')" class="col-12 col-md-6">
			<view class="diy_title">
				<text>
					用户身份:
				</text>
...
<script>
	export default {
		...
		methods: {
			...
			change_user_identity(val) {
				if (val === "全部" || val === "") {
					this.$emit('change',{"value":"","type":"user_identity"})
				}else{
					this.$emit('change',{"value":val,"type":"user_identity"})
				}
			},
				/**
			 * 上传图片
