<template>
  <view class="page_barter diy_table diy_table_tml" id="barter_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/barter/view?" v-show="user_group == '管理员' || $check_action('/barter/table','add') || $check_action('/barter/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','required_barter')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>所需易物</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/barter/table','del') || $check_action('/barter/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/barter/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/barter/table','set') || $check_action('/barter/view','set') || $check_action('/barter/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 获取数据地址
				url_get_list: "~/api/barter/get_list?like=0",
				url_del: "~/api/barter/del?",
