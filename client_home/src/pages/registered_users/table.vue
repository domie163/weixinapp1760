            ...
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="用户姓名" name="user_name">
                      ...
                      <uni-forms-item label="用户身份" name="user_identity">
                 <uni-data-select placeholder="请选择"
                        v-model="query['user_identity']"
                            ...
                            <span>用户性别</span>
								...
								<text>
									{{ o["user_gender"] }}
													...
													<view v-if="1 && $check_field('get','user_identity')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>用户身份</span>
                          </view>
		...
		data() {
			return {
                ...
                list_user_gender: [{value:"",text:"全部"}],
                            // 用户身份列表
                list_user_identity: [{value:"",text:"全部"}],
        			}
		},
		methods: {
          search() {
